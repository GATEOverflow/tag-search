...
class qa_tagsearch_widget {
	...
	function output_widget($region, $place, $themeobject, $template, $request, $qa_content)
	{
		...
		$out='<div class="qam-tag-search"> <div class="qa-tag-search">
			...
			<span id="tag_search_hints"></span></div> 
			<button type="submit" value="tagsearch" class="qa-tag-search-button fa fa-search"></button>
			<input type="checkbox" id="exact-tag-match" name="exact-tag-match" title="Exact tag match">
</form>
			</div> </div>';
